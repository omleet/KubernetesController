                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Update the A record details</p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{route('updateDnsRecord',[$deviceParam, $record['.id']])}}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-4 bg-white dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                                <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Record Name</label>
                                <input type="text" id="name" name="name" value="{{$record['name']}}"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white @error('name') border-red-500 @enderror"
                                    placeholder="My DNS record name">
                                @error('name')
                            ...
                            <!-- Address Field -->
                            <div class="p-4 bg-white dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                                <label for="address" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">IP Address</label>
                                <input type="text" id="address" name="address" value="{{$record['address']}}"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white @error('address') border-red-500 @enderror"
