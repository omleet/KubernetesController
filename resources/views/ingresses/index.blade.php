    ...
    <x-slot name="header">
        <div class="flex flex-col">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage network routing rules for your cluster
            </p>
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-gradient-to-r from-indigo-700 to-purple-700 rounded-2xl shadow-xl overflow-hidden">
                <div class="px-6 py-8 md:px-10 md:py-10 text-white">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold">Cluster Ingresses</h2>
                            <p class="mt-2 text-indigo-100"> Manage network routing rules for your cluster</p>
                        </div>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    <div>
                        <select class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm"
                            name="showNamespaceData">
                            <option value="All" {{ (app('request')->input('showNamespaceData') == 'All' || app('request')->input('showNamespaceData') == null) ? "selected" : ""}}>All Namespaces</option>
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('Ingresses.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                    <svg class="-ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Ingresses</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ count($ingresses) }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Unique Services</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        ...
                                        $uniqueServices[$service['serviceName']] = true;
                                        }
                                        }
                                        echo count($uniqueServices);
                                        @endphp
                                    </div>
                                </dd>
                            </dl>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Namespaces with Ingresses</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        @php
                                        $uniqueNamespaces = [];
                                        foreach ($ingresses as $ingress) {
                                        $uniqueNamespaces[$ingress['namespace']] = true;
                                        }
                                        echo count($uniqueNamespaces);
                                        @endphp
                                    </div>
                                </dd>
                            </dl>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between flex-wrap sm:flex-nowrap">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Ingresses</h3>
                        <p class="mt-1 text-sm text-gray-500">A list of all ingresses in your Kubernetes cluster.</p>
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="space-y-1">
                                    @foreach ($ingress['services'] as $service)
                                    <div class="text-sm text-indigo-600 font-medium">{{ $service['path'] }}</div>
                                    @endforeach
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-3">
                                    <a href="{{ route('Ingresses.show', [$ingress['namespace'], $ingress['name']]) }}"
