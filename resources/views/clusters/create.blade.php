        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-xl font-semibold text-gray-900">Cluster Configuration</h2>
                        <p class="text-sm text-gray-500 mt-1">
                            Enter the details to connect to your Kubernetes cluster
                        </p>
                    </div>
                </div>
            </div>
                ...
                <form method="POST" action="{{route('Clusters.store')}}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="name" class="pl-10 focus:ring-indigo-500 focus:border-indigo-500 block w-full px-4 py-3 border border-gray-300 rounded-md @error('name') border-red-500 @enderror" value="{{old('name')}}" placeholder="e.g. Production Cluster">
                                @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="endpoint" class="pl-10 focus:ring-indigo-500 focus:border-indigo-500 block w-full px-4 py-3 border border-gray-300 rounded-md @error('endpoint') border-red-500 @enderror" value="{{old('endpoint') ?? 'http://172.29.176.1:8001'}}" placeholder="http://172.29.176.1:8001">
                                @error('endpoint')
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                            ...
                            <div class="mt-1 space-y-4">
                                <div class="relative flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="auth-proxy" name="auth_type" type="radio" x-model="authType" value="P" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" {{ old('auth_type', 'P') == 'P' ? 'checked' : '' }}>
                                    </div>
                                ...
                                <div class="relative flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="auth-token" name="auth_type" type="radio" x-model="authType" value="T" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" {{ old('auth_type') == 'T' ? 'checked' : '' }}>
                                    </div>
                                    <div class="ml-3 text-sm">
                    ...
                    <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="number" name="timeout" min="1" max="60" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full px-4 py-3 border border-gray-300 rounded-md @error('timeout') border-red-500 @enderror" value="{{old('timeout') ?? '5'}}" placeholder="5">
                                @error('timeout')
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        <a href="{{ route('Clusters.index') }}" class="inline-flex items-center px-4 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200">
