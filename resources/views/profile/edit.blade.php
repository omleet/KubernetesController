                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Update your account details and email address</p>
                        </div>
                    </div>
                    <div class="max-w-xl">
                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Change your password and security preferences</p>
                        </div>
                    </div>
                    <div class="max-w-xl">
