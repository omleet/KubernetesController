    ...
    <x-slot name="header">
        <div class="flex flex-col">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage the deployments running in your Kubernetes Cluster
            </p>
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-gradient-to-r from-indigo-700 to-purple-700 rounded-2xl shadow-xl overflow-hidden">
                <div class="px-6 py-8 md:px-10 md:py-10 text-white">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold">Cluster Deployments</h2>
                            <p class="mt-2 text-indigo-100">Manage the deployments running in your Kubernetes Cluster</p>
                        </div>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <form method="GET" class="flex bg-white rounded-lg shadow-sm p-3 border border-gray-200">
                <div class="flex flex-wrap items-center gap-4">
                    <div class="flex items-center">
                        <label class="text-sm font-medium text-gray-700 mr-2">Namespace:</label>
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('Deployments.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                    <svg class="-ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ count($deployments) }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Replicas</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        {{ array_reduce($deployments, function($carry, $item) { return $carry + (int)$item['replicas']; }, 0) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        {{ array_reduce($deployments, function($carry, $item) { return $carry + (int)$item['totalContainers']; }, 0) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between flex-wrap sm:flex-nowrap">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Deployments</h3>
                        <p class="mt-1 text-sm text-gray-500">A list of all deployments in your Kubernetes cluster.</p>
                    </div>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                    ...
                                    {{ $deployment['totalContainers'] }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-3">
                                    <a href="{{ route('Deployments.show', [$deployment['namespace'], $deployment['name']]) }}"
