                ...
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">IP Address Details</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Configuration and settings for this IP address</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div class="space-y-6">
                            <div class="p-4 bg-white dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <dl class="space-y-4">
                                    <div>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white font-mono">{{ $address['address'] ?? '-' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Network</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white font-mono">{{ $address['network'] ?? '-' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Interface</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $address['interface'] ?? '-' }}</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div class="p-4 bg-white dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                                ...
                                <dl class="space-y-4">
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Disabled</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $address['disabled'] ?? 'no' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Dynamic</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $address['dynamic'] ?? 'no' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Invalid</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $address['invalid'] ?? 'no' }}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 flex justify-end space-x-3">
                        <a href="{{ route('IPAddresses.index', $deviceParam) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600">
