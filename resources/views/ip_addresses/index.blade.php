                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500 ">Device's IP address configuration</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 ">
                            <thead class="bg-gray-50 ">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500  uppercase tracking-wider">Interface (Actual Interface)</th>
                            ...
                            <tbody class="bg-white  divide-y divide-gray-200 ">
                                ...
                                <tr class="hover:bg-gray-50 ">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ">{{ $address['network'] }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                        <div class="flex justify-end space-x-3">
                                            <a href="{{ route('IPAddresses.show', [$deviceParam, $address['.id']]) }}" class="text-blue-600 hover:text-blue-900  " title="Details">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                                    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                                                </svg>
                                            </a>
                                            <a href="{{ route('IPAddresses.edit', [$deviceParam, $address['.id']]) }}" class="text-gray-600 hover:text-gray-900  " title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                </svg>
                                            </a>
                                            @if (!isset($address['comment']) || $address['comment'] != 'defconf')
                                            <a href="#" onclick="_delete('Are you sure you want to delete the IP Address &quot;{{$address["address"]}}&quot; ({{$address[".id"]}})','{{ route("IPAddresses.destroy", [$deviceParam, $address[".id"]]) }}')" class="text-red-600 hover:text-red-900  " title="Delete">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
