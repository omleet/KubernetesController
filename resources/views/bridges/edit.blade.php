    ...
    <x-slot name="header">
        <div class="flex flex-col space-y-1">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
                Edit Bridge "{{ $bridge['name'] }}"
            </h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Update the bridge interface configuration
            </p>
        </div>
    </x-slot>
                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Update the settings for bridge "{{ $bridge['name'] }}"</p>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('Bridges.update', [$deviceParam, $bridge['.id']]) }}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                ...
                                <input type="text" id="name" name="name" value="{{ $bridge['name'] }}"
                            ...
                            <!-- Ageing Time Field -->
                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <label for="ageing-time" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ageing time (optional)</label>
                                <input type="text" id="ageing-time" name="ageing-time" 
                                       value="{{ $bridge['ageing-time'] ?? '' }}"
                            ...
                            <!-- MTU Field -->
                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <label for="mtu" class="block text-sm font-medium text-gray-700 dark:text-gray-300">MTU (optional)</label>
                            ...
                            <!-- MAC Address Field -->
                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <label for="admin-mac" class="block text-sm font-medium text-gray-700 dark:text-gray-300">MAC Address (optional)</label>
                                <input type="text" id="admin-mac" name="admin-mac" 
                                       value="{{ $bridge['admin-mac'] ?? '' }}"
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="dhcp-snooping" name="dhcp-snooping" type="checkbox" value="1"
                                               ...
                                               {{ $bridge['dhcp-snooping'] == "true" ? 'checked' : '' }}>
                                    </div>
                                    <div class="ml-3 text-sm">
                                        <label for="dhcp-snooping" class="font-medium text-gray-700 dark:text-gray-300">DHCP Snooping</label>
                                        @error('dhcp-snooping')
                                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
