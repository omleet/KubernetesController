    ...
    <x-slot name="header">
        <div class="flex flex-col space-y-1">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Configure a new DHCP client for network interface
            </p>
        </div>
    </x-slot>
    <div class="py-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">DHCP Client Configuration</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Set up a new DHCP client</p>
                        </div>
                    </div>
