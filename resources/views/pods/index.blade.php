    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-gradient-to-r from-indigo-700 to-purple-700 rounded-2xl shadow-xl overflow-hidden">
                <div class="px-6 py-8 md:px-10 md:py-10 text-white">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold">Pods</h2>
                            <p class="mt-2 text-indigo-100">Check All The List of Pods</p>
                        </div>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <form method="GET" class="flex bg-white rounded-lg shadow-sm p-3 border border-gray-200">
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <label class="inline-flex items-center">
                        <input id="showDefault" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="showDefault" value="true" {{app('request')->input('showDefault')!=null ? "checked" : ""}}>
                        <span class="ml-2 text-gray-700 text-sm">Show default Namespaces</span>
                    </label>
                    
                    <label class="inline-flex items-center">
                        <input id="hideDeploymentPods" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="hideDeploymentPods" value="true" {{app('request')->input('hideDeploymentPods')!=null ? "checked" : ""}}>
                        <span class="ml-2 text-gray-700 text-sm">Hide Deployment Pods</span>
                    </label>
            ...
            <div class="flex space-x-3">
                <a href="{{ route('Pods.index', request()->query()) }}" class="refresh-btn inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200">
                ...
                <a href="{{ route('Pods.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200">
                    <svg class="-ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Total Pods</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ count($pods) }}</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Running Pods</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        {{ count(array_filter($pods, function($pod) { return isset($pod['status']) && $pod['status'] == 'Running'; })) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Pending/Terminating Pods</dt>
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">
                                        {{ count(array_filter($pods, function($pod) { return isset($pod['status']) && ($pod['status'] == 'Pending' || $pod['status'] == 'Terminating'); })) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between flex-wrap sm:flex-nowrap">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Pods</h3>
                        <p class="mt-1 text-sm text-gray-500">A list of all pods in your Kubernetes cluster.</p>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pod IP(s)</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Containers</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-3">
                                    <a href="{{route('Pods.show',[$pod['namespace'],$pod['name']])}}"
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <div class="-mx-2 -my-1.5 flex">
                                    <a href="{{ route('Pods.index') }}" class="refresh-btn bg-red-50 px-2 py-1.5 rounded-md text-sm font-medium text-red-800 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 inline-flex items-center">
